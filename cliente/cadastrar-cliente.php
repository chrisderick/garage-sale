...
<body>
	...
	<form action="index.php?page=sal-cliente&acao=cadastrar" method="POST">
		...
		<div class="container">
			<div class="row">
				...
				<div class="form-group col-3">
					...
					<input type="date" name="nasc_cliente" class="form-control">
				</div>
			</div>
			...
			<div class="form-group col-6">
					<label>Posição</label>
					<input type="text" name="posicao_cliente" class="form-control">
			</div>
			...
			<div class="row">
				...
				<div class="form-group col-2 mx-auto">
					...
					<select class="form-control" id="solo_cliente" onchange="optionCheck()">
				...
				<div class="form-group col-10 mx-auto" id="gravadora" style="visibility: hidden;">
			 	...
			 	<script type="text/javascript">
				    function optionCheck(){
				        var option = document.getElementById("solo_cliente").value;
				        if(option == 1){
